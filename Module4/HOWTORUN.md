...
- Run all the code cells in 'module4.ipynb' sequentially from top to bottom 
- The code in module4_animal_segmentation.ipynb' is just to show the process on how I fixed the filter for better segmentation